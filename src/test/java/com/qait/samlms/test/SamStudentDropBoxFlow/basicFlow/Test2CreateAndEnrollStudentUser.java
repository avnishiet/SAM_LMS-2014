...
public class Test2CreateAndEnrollStudentUser extends BaseTest{
	...
	public void createAndEnrollUser() {
		...
		test.userPageAction.clickOnSectionTabInUserPage();
		test.userPageAction.selectSectionToEnrolUser(sectionName);
		test.sectionPageAction.clickOnMoveButton();
		test.userPageAction.selectSectionToEnrolUser(secondSectionName);
		test.sectionPageAction.clickOnMoveButton();
