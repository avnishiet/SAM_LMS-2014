...
public class Test3aVerifyTheDropboxFromInstructorEnd extends BaseTest {
	...
	public void verifyDropBoxFromInstructorSide() {
	...
	@Test(dependsOnMethods = "verifyDropBoxFromInstructorSide")
